<template>
    <v-container>
        ...
        <v-dialog v-model="dialogNuevaAsignacion" max-width="600px">
            <crear-asignacion @close="dialogNuevaAsignacion = false" @saved="fetchAsignacion"></crear-asignacion>
        </v-dialog>

        <v-dialog v-model="dialogDetalleAsignacion" max-width="600px">
            <detalle-asignacion :idComercio="asignacionSeleccionada.idComercio"
                :idEstado="asignacionSeleccionada.idEstado" :idServicio="asignacionSeleccionada.idServicio"
                @close="dialogDetalleAsignacion = false">
            </detalle-asignacion>
        </v-dialog>

        <v-dialog v-model="dialogEditarAsignacion" max-width="600px">
            <editar-asignacion :idComercio="asignacionSeleccionada.idComercio"
                :idEstado="asignacionSeleccionada.idEstado" :idServicio="asignacionSeleccionada.idServicio"
