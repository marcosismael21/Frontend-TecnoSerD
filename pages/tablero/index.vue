...
export default {
  ...
  methods: {
    async fetchSparklineData() {
      try {
        const resInstalaciones = await axios.get('http://localhost:3010/api/v1/tablero/sparkline-instalaciones')
        ...
        const resSoportes = await axios.get('http://localhost:3010/api/v1/tablero/sparkline-soportes')
        ...
        const resRetiros = await axios.get('http://localhost:3010/api/v1/tablero/sparkline-retiros')
    ...
    async fetchBarData() {
      try {
        const res = await axios.get('http://localhost:3010/api/v1/tablero/servicios-por-ciudad')
    ...
    async fetchDonutData() {
      try {
        const res = await axios.get('http://localhost:3010/api/v1/tablero/asignaciones-por-estado')
    ...
    async fetchAreaData() {
      try {
        const res = await axios.get('http://localhost:3010/api/v1/tablero/crecimiento-equipos-por-estado')
        this.areaSeries = [
          {
            name: 'Crecimiento',
    ...
    async fetchPieData() {
      try {
        const res = await axios.get('/tablero/cantidad-estado')
