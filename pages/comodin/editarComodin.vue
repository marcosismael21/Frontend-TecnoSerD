<template>
  <v-card v-if="!isLoading && equipo">
    ...
    <v-card-text>
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-row>
          <v-col cols="12">
            <v-autocomplete v-model="equipo.idTipoEquipo" :items="Tipoequipo" item-text="nombre" item-value="id"
  ...
  <v-alert v-else-if="!isLoading && !comodin" type="error">No se pudo cargar la información del Equipo.</v-alert>
</template>
